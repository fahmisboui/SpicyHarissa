...
export default function Games() {
  ...
  return (
    ...
    >
      ...
      style={{
        backgroundImage: `url(${window.innerWidth <= 768 ? games[currentIndex].imageMobile : games[currentIndex].imageDesktop})`, // Conditional background image
      }}
    >
    </div>
    </div>
          ...
          <div className="absolute inset-0 z-20 flex flex-col justify-center px-4 sm:px-24">
            <div className="w-full sm:w-1/2">
              ...
              <div className="flex items-center mb-4">
                ...
                <span className="text-white text-sm">Available on Google Play Store</span>
              </div>
              ...
              >
                <button className="w-[150px] h-12 rounded-lg bg-white text-black font-semibold">
                  Download
                </button>
              </a>
            </div>
